...
ALLOWED_FIELDS_PER_DOMAIN: dict[HADomain, dict[str, set[str]]] = {
	...
	HADomain.ALARM_CONTROL_PANEL: {
		...
		"optional": COMMON_FIELDS | {"state_topic", "code", "code_arm_required",
			"payload_arm_home", "payload_arm_away",
			"payload_arm_night", "payload_arm_vacation",
			"payload_disarm"},
	},
	HADomain.BUTTON: {
		"required": {"name", "command_topic", "unique_id"},
	...
	HADomain.LAWN_MOWER: {
		"required": {"name", "command_topic", "unique_id"},
		"optional": COMMON_FIELDS | {"state_topic", "payload_start", "payload_pause",
			"payload_stop", "payload_return_to_base"},
	},
	HADomain.SCENE: {
		"required": {"name", "command_topic", "unique_id"},
	...
	HADomain.SIREN: {
		"required": {"name", "command_topic", "unique_id"},
		"optional": COMMON_FIELDS | {"state_topic", "available_tones",
			"tone_command_topic", "tone_state_topic",
			"duration_command_topic", "duration_state_topic"},
	},
	HADomain.UPDATE: {
		"required": {"name", "state_topic", "unique_id"},
		"optional": COMMON_FIELDS | {"command_topic", "payload_install",
			"latest_version_template", "installed_version_template"},
	},
	HADomain.VALVE: {
		"required": {"name", "command_topic", "unique_id"},
		"optional": COMMON_FIELDS | {"state_topic", "position_command_topic",
			"position_state_topic", "set_position_template"},
	},
	HADomain.SENSOR: {
		"required": {"name", "state_topic", "unique_id"},
		"optional": COMMON_FIELDS | STATE_FIELDS | {"device_class", "unit_of_measurement",
			"state_class", "last_reset_value_template"},
	},
	...
	HADomain.LIGHT: {
		"required": {"name", "command_topic", "unique_id"},
		"optional": COMMON_FIELDS | COMMAND_FIELDS | {"state_topic", "brightness_command_topic",
			"brightness_state_topic", "brightness_scale",
			"color_temp_command_topic", "color_temp_state_topic",
			"effect_command_topic", "effect_state_topic",
			"hs_command_topic", "hs_state_topic",
			"rgb_command_topic", "rgb_state_topic",
			"xy_command_topic", "xy_state_topic"},
	},
	HADomain.COVER: {
		"required": {"name", "command_topic", "unique_id"},
		"optional": COMMON_FIELDS | {"state_topic", "position_command_topic",
			"tilt_command_topic", "tilt_state_topic",
			"set_position_template", "set_tilt_template"},
	},
	HADomain.FAN: {
		"required": {"name", "command_topic", "unique_id"},
		"optional": COMMON_FIELDS | {"state_topic", "percentage_command_topic",
			"percentage_state_topic", "preset_mode_command_topic",
			"preset_mode_state_topic", "oscillation_command_topic",
	...
	HADomain.VACUUM: {
		"required": {"name", "command_topic", "unique_id"},
		"optional": COMMON_FIELDS | {"state_topic", "fan_speed_command_topic",
			"fan_speed_state_topic", "send_command_topic"},
	},
	HADomain.WATER_HEATER: {
		"required": {"name", "command_topic", "unique_id"},
		"optional": COMMON_FIELDS | {"state_topic", "temperature_command_topic",
			"temperature_state_topic", "modes"},
	},
	HADomain.CLIMATE: {
